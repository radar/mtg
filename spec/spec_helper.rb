...
module CardHelper
  ...
  def cast_action(card:, player: card.owner, targeting: nil, flashback: false, alternative: false, &block)
    action = Magic::Actions::Cast.new(card: card, player: player, game: game, flashback: flashback, alternative: alternative)
