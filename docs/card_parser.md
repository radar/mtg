...
scry, look at the top N cards and take a <Type>, <Type>, or <Type> card into your hand with the rest on the bottom (`LookAtTopCards`, `Choice::LookAtTopCards`), mill (`Mill`: you, each opponent, target player/opponent), surveil (`Surveil`, a `Choice::Surveil`, like scry), untap (`Untap`: target, ~, "each other <Type> you control"), blight (`Blight`: you
