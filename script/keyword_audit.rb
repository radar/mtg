...
PARTIAL = {
  ...
  "Offspring" => "`Actions::Cast#offspring_cost`/`#pay_offspring`, `Offspring::TokenCopyTrigger`, `Abilities::Static::GrantOffspring`. No `Card` DSL macro yet (a card defines `offspring_cost` returning a cost hash).",
